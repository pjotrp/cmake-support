...
if (USE_SWIG_INCLUDEPATH AND USE_SWIG_INCLUDEALL)
  SET_SOURCE_FILES_PROPERTIES(${INTERFACE} PROPERTIES SWIG_FLAGS "-includeall;-I${USE_SWIG_INCLUDEPATH};${USE_SWIG_FLAGS};${BUILD_FLAG}")
endif ()
...
SWIG_LINK_LIBRARIES(${M_MODULE} ${MODULE_LIBRARY} ${USE_LANGUAGE_LIBRARY} ${CORE_LIBRARY} ${R_LIBRARY} ${ZLIB_LIBRARY} ${BIOLIB_R_LIBRARY})
